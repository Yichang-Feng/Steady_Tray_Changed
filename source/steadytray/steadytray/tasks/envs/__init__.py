...
gym.register(
    id="G1-Arm-Posture-Walking",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.arm_posture_env_cfg:ArmPostureEnvCfg",
        "play_env_cfg_entry_point": f"{__name__}.arm_posture_env_cfg:ArmPosturePlayEnvCfg",
        "rsl_rl_cfg_entry_point": f"steadytray.tasks.agents.rsl_rl_ppo_cfg:G1PPORunnerCfg",
    },
)
...
gym.register(
    id="G1-Steady-Tray-Separated",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.steady_tray_separated_env_cfg:SteadyTraySeparatedEnvCfg",
        "play_env_cfg_entry_point": f"{__name__}.steady_tray_separated_env_cfg:SteadyTraySeparatedPlayEnvCfg",
        "rsl_rl_cfg_entry_point": f"steadytray.tasks.agents.rsl_rl_ppo_cfg:BasePPORunnerCfg",
    },
)

gym.register(
    id="G1-Steady-Tray-Distillation",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.steady_tray_distill_env_cfg:SteadyTrayDistillEnvCfg",
        "play_env_cfg_entry_point": f"{__name__}.steady_tray_distill_env_cfg:SteadyTrayDistillPlayEnvCfg",
        "rsl_rl_cfg_entry_point": f"steadytray.tasks.agents.rsl_rl_ppo_cfg:G1AdapterDistillationRunnerCfg",
    },
)
