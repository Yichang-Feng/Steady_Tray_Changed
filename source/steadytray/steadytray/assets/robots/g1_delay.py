...
G1_DELAY_CFG = unitree.UnitreeArticulationCfg(
    ...
    joint_sdk_names=unitree.UNITREE_G1_29DOF_CFG.joint_sdk_names,
)

G1_DELAY_ACTION_SCALE = {}
for a in G1_DELAY_CFG.actuators.values():
    ...
    for n in names:
        if n in e and n in s and s[n]:
            G1_DELAY_ACTION_SCALE[n] = 0.25 * e[n] / s[n]
